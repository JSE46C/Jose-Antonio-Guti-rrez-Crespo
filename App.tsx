    ...
    <div className="min-h-screen bg-[#f1f5f9] p-4 md:p-8 font-sans text-slate-900">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          {/* Columna Derecha: Resultados y Simulación */}
          <div className="lg:col-span-8 space-y-10">
            {/* Trayectoria 2D como prioridad visual */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <section className={`p-10 rounded-[3rem] border-4 ${theme.border} ${theme.bg} shadow-2xl transition-all duration-700`}>
                ...
                <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white/80 p-5 rounded-2xl border border-white shadow-sm text-center">
                    ...
                    <div className="bg-white/80 p-5 rounded-2xl border border-white shadow-sm text-center">
                      <p className="text-[9px] uppercase font-black text-slate-400 mb-1 tracking-widest">Alcance Est.</p>
              ...
              <section className="bg-white p-10 rounded-[3rem] shadow-xl border border-slate-100 flex flex-col">
                    ...
                    result.compatibleModels.map((model, idx) => (
                      <div key={model.id} className={`p-5 rounded-2xl border-2 transition-all cursor-default ${idx === 0 ? 'border-indigo-500 bg-indigo-50/30' : 'border-slate-50 bg-slate-50/50 hover:border-slate-200'}`}>
                        <div className="flex justify-between items-start mb-3">
                          ...
                          {idx === 0 && <span className="bg-indigo-600 text-white text-[8px] px-2 py-0.5 rounded-full font-black uppercase shadow-md shadow-indigo-200">Ideal</span>}
                        </div>
                        <div className="flex gap-6 mt-4">
                            <div>
                                <p className="text-[8px] font-bold text-slate-400 uppercase mb-1">H Máx Trabajo</p>
                                <p className="text-sm font-black text-slate-800">{model.maxWorkHeight}m</p>
                            </div>
                            {model.maxReach && (
                                <div className="border-l border-slate-200 pl-4">
                                    <p className="text-[8px] font-bold text-slate-400 uppercase mb-1">Alcance Lateral</p>
                ...
                <div className="mt-8 pt-6 border-t border-slate-50">
                    <a 
                      href="https://grupomainsa.es/alquiler-plataformas-cantabria/" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="w-full bg-slate-900 text-white font-black uppercase tracking-widest py-5 rounded-2xl shadow-lg hover:bg-indigo-600 hover:shadow-indigo-200 transition-all flex items-center justify-center gap-3 group"
                    >
      ...
      <footer className="max-w-7xl mx-auto mt-20 pt-10 border-t border-slate-200 text-center opacity-40">
         <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.6em]">Mainsa Data Engine &copy; 2025 | Sistema de Selección de Flota</p>
      </footer>
    </div>
  );
};
